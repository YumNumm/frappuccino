...
CREATE TABLE IF NOT EXISTS public.profiles(
  ...
  uuid UUID PRIMARY KEY REFERENCES auth.users on delete cascade,
...
FROM
  ...
  LEFT JOIN public.reservations r ON p.id = r.user_id
  LEFT JOIN public.reservation_slots s ON r.slot_id = s.id
...
FROM
  public.groups as g
  LEFT JOIN public.reservation_slots s ON g.id = s.group_id
WHERE
  g.id = _group_id
GROUP BY
  g.id;
...
------------------ Mock data ------------------
INSERT INTO public.groups (class, name, description, place, type, image_url)
VALUES
('H1-1', 'サンプルクラス 高校1-1', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H1-2', 'サンプルクラス 高校1-2', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H1-3', 'サンプルクラス 高校1-3', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H1-4', 'サンプルクラス 高校1-4', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H1-5', 'サンプルクラス 高校1-5', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H2-1', 'サンプルクラス 高校2-1', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H2-2', 'サンプルクラス 高校2-2', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H2-3', 'サンプルクラス 高校2-3', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H2-4', 'サンプルクラス 高校2-4', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H2-5', 'サンプルクラス 高校2-5', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png'),
('H3-1', 'サンプルクラス 高校3-1', 'ほげほげします', 'S51', 'class', 'https://placehold.jp/150x150.png')
;
